...
#ifdef CH_PARAM
	TCHAR SAVE_ROOT[MAX_PATH]			= _T("\\Ran Onlin\\");

	TCHAR PLAYINFO_ROOT[MAX_PATH]		= _T("\\Ran Onlin\\play\\");
	TCHAR DEBUGINFO_ROOT[MAX_PATH]		= _T("\\Ran Onlin\\errlog\\");
	TCHAR CAPTURE[MAX_PATH]				= _T("\\Ran Onlin\\screen\\");
	TCHAR CHATLOG[MAX_PATH]				= _T("\\Ran Onlin\\chatlog\\");
#elif TW_PARAM 
	TCHAR SAVE_ROOT[MAX_PATH]			= _T("\\Ran Online\\");

	TCHAR PLAYINFO_ROOT[MAX_PATH]		= _T("\\Ran Online\\play\\");
	TCHAR DEBUGINFO_ROOT[MAX_PATH]		= _T("\\Ran Online\\errlog\\");
	TCHAR CAPTURE[MAX_PATH]				= _T("\\Ran Online\\screen\\");
