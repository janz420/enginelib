...
namespace COMMENT
{
	...
	extern std::string ANI_MAINTYPE_00[ANI_VEHICLE_SIZE]; //Vehicle main Ani Keys | Janzs420
	extern std::string ANI_MAINTYPE_01[ANI_ABL_SIZE]; //Vehicle main Ani Keys | Janzs420
