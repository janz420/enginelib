...
//Added by XMEN2 | 8-8-2012 | Add ABL and ABF code
...
public:
	HRESULT ClearAll ();
	//added by XMEN2 | 18-7-2012 | Add ABL and ABF code
	HRESULT Clear( EMPIECECHAR emType );
...
public:
	...
	WORD GetHairColor();
	void SetColorAll( WORD wColor );// Added By Janzs420
