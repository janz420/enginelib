...
//added by XMEN2 | 18-7-2012 | Add ABL and ABF code
BOOL DxSkinCharData::SaveFile_B ( const char* szFile, LPDIRECT3DDEVICEQ pd3dDevice )
{
...
//added by XMEN2 | 18-7-2012 | Add ABL and ABF code
BOOL DxSkinCharData::LOAD_Ver103( basestream &SFile, LPDIRECT3DDEVICEQ pd3dDevice )
{
	DWORD dwPieceSize;
...
BOOL DxSkinCharData::LoadFile ( const char* szFile, LPDIRECT3DDEVICEQ pd3dDevice, const BOOL bThread, bool bREPRESH )
{
	...
	//added by XMEN2 | 18-7-2012 | Add ABL and ABF code
		...
		break;
	case 0x0102:
	//Added by Janzs420 | Existing ABL and ABF Code missing!!!!!
